...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-24MVNLEJ.js");
    case "./translations/es.json":
      return import("./es.json-362XD67N.js");
    case "./translations/fr.json":
      return import("./fr.json-HAZDXQD3.js");
    case "./translations/it.json":
      return import("./it.json-CV64WVTO.js");
    case "./translations/ru.json":
      return import("./ru.json-NEZLPOYT.js");
    case "./translations/uk.json":
      return import("./uk.json-N7FF7KIB.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-GRFL4KEW.js");
          return App;
        }
      });
      const plugin = {
