import {
  ...
  HOOKS
} from "./chunk-H2F2VPFP.js";
import {
  useNpsSurveySettings
} from "./chunk-GKCNZZZM.js";
import {
  require_pick
} from "./chunk-43VJM56Y.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  HistoryProvider
} from "./chunk-6ZA43GMR.js";
import {
  useEnterprise
} from "./chunk-DBFB3JSV.js";
import {
  getBasename
} from "./chunk-FKZISMKU.js";
import {
  useClipboard
} from "./chunk-HF4RDOZJ.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-T7SQIXTA.js";
import {
  Layouts
} from "./chunk-EHTRFEEW.js";
import {
  Login
} from "./chunk-7XTT7RMQ.js";
import {
  errorsTrads
} from "./chunk-VOKNWBQ3.js";
import {
  ValidationError,
  create,
  create4 as create2,
...
} from "./chunk-CZMZADAS.js";
import {
  ConfigurationProvider
} from "./chunk-EGTLGH7I.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-DCYYKYZH.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-3LNE4R2Z.js";
import {
  getByteSize
} from "./chunk-XBJE3IAP.js";
import {
  RESPONSIVE_DEFAULT_SPACING
} from "./chunk-HY4Y26UY.js";
import {
  require_isEqual
} from "./chunk-OKPKSLV7.js";
import {
  Page,
  l1,
  useAPIErrorHandler
...
import {
  _extends
} from "./chunk-VOLXBSNO.js";
import {
  require_react_dom
} from "./chunk-AJE3QHGI.js";
import {
  require_react
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-EUABT5UG.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-2YZMQJG2.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-D3KAXTDQ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-ELOVNBPU.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BDPVMUE7.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-QQXXOGCV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-B2656ULB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ED5JZC42.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-2GNSUZJA.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-6QN7FCK3.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-MCTSNYZA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-N2MDGVMA.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ZZAOUEMS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DYW4DNRJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-GTFMF4BZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-7V423WPP.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-6K7VYYSI.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-GAVLLO64.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-H74M3LMB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-BTXB3LNH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-DK2O2CTP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-TTBESDQX.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-X4RG5HB5.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-4QM56XZK.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-262QKLXS.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-Y6JARSX2.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-LCPE5NTK.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-VF4GJXUI.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-37S4GF57.js");
    case "./translations/ca.json":
      return import("./ca.json-XEFEXX2O.js");
    case "./translations/cs.json":
      return import("./cs.json-JUMDGQJI.js");
    case "./translations/de.json":
      return import("./de.json-GU7Q3ZSM.js");
    case "./translations/dk.json":
      return import("./dk.json-M6DIVFID.js");
    case "./translations/en.json":
      return import("./en.json-KS56F3YE.js");
    case "./translations/es.json":
      return import("./es.json-5PTZERZP.js");
    case "./translations/eu.json":
      return import("./eu.json-VGJIPMJT.js");
    case "./translations/fr.json":
      return import("./fr.json-7FLRUHQP.js");
    case "./translations/gu.json":
      return import("./gu.json-7LBGADTK.js");
    case "./translations/he.json":
      return import("./he.json-I5BZJXAX.js");
    case "./translations/hi.json":
      return import("./hi.json-F4GKIGIE.js");
    case "./translations/hu.json":
      return import("./hu.json-IR3WGXND.js");
    case "./translations/id.json":
      return import("./id.json-YIVNV5MF.js");
    case "./translations/it.json":
      return import("./it.json-WODWY7J7.js");
    case "./translations/ja.json":
      return import("./ja.json-N62COKQD.js");
    case "./translations/ko.json":
      return import("./ko.json-KBX6NCNZ.js");
    case "./translations/ml.json":
      return import("./ml.json-PFMQOWQ5.js");
    case "./translations/ms.json":
      return import("./ms.json-CHTVV72C.js");
    case "./translations/nl.json":
      return import("./nl.json-JHJSSBTK.js");
    case "./translations/no.json":
      return import("./no.json-UTR6W4CC.js");
    case "./translations/pl.json":
      return import("./pl.json-DSX7FRB2.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-PLTKBTFB.js");
    case "./translations/pt.json":
      return import("./pt.json-GHDHEXPO.js");
    case "./translations/ru.json":
      return import("./ru.json-RVQSVJ6S.js");
    case "./translations/sa.json":
      return import("./sa.json-AQBWW3II.js");
    case "./translations/sk.json":
      return import("./sk.json-ZLXNG3EY.js");
    case "./translations/sv.json":
      return import("./sv.json-XW4F2XWO.js");
    case "./translations/th.json":
      return import("./th.json-BT4II7UA.js");
    case "./translations/tr.json":
      return import("./tr.json-GH77DTP5.js");
    case "./translations/uk.json":
      return import("./uk.json-4HHMV5MT.js");
    case "./translations/vi.json":
      return import("./vi.json-Z52PH5ML.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-ZPRHPUMK.js");
    case "./translations/zh.json":
      return import("./zh.json-RNAIVL27.js");
    default:
      return new Promise(function(resolve, reject) {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-42L236QM.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-B7W2HJ3A.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-B7W2HJ3A.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-OFVYUVVZ.js");
...
//# sourceMappingURL=chunk-Q4ZKUKA5.js.map
