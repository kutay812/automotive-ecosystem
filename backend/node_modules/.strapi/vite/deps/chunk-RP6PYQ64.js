...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-NNPIKWFU.js");
    case "./translations/ca.json":
      return import("./ca.json-D46GUWXU.js");
    case "./translations/cs.json":
      return import("./cs.json-5PUFZUGN.js");
    case "./translations/de.json":
      return import("./de.json-466LLUWN.js");
    case "./translations/en.json":
      return import("./en.json-FFTN7BGU.js");
    case "./translations/es.json":
      return import("./es.json-UBYQ7V4N.js");
    case "./translations/eu.json":
      return import("./eu.json-AQIAZRIP.js");
    case "./translations/fr.json":
      return import("./fr.json-4VDCXQTM.js");
    case "./translations/gu.json":
      return import("./gu.json-RZIMRFED.js");
    case "./translations/hi.json":
      return import("./hi.json-EVR7HZ2S.js");
    case "./translations/hu.json":
      return import("./hu.json-G6VDHV7D.js");
    case "./translations/id.json":
      return import("./id.json-HIXY7FMC.js");
    case "./translations/it.json":
      return import("./it.json-DOXA4JDT.js");
    case "./translations/ja.json":
      return import("./ja.json-CW2SR37Y.js");
    case "./translations/ko.json":
      return import("./ko.json-KTY66E7T.js");
    case "./translations/ml.json":
      return import("./ml.json-I2FGNPL3.js");
    case "./translations/ms.json":
      return import("./ms.json-4L6MYWLN.js");
    case "./translations/nl.json":
      return import("./nl.json-VZTCAJ24.js");
    case "./translations/pl.json":
      return import("./pl.json-FKH2A2PX.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-AV6CKPOX.js");
    case "./translations/pt.json":
      return import("./pt.json-RYRJ2QLW.js");
    case "./translations/ru.json":
      return import("./ru.json-GKQ762DM.js");
    case "./translations/sa.json":
      return import("./sa.json-DH4AZWGN.js");
    case "./translations/sk.json":
      return import("./sk.json-SWWIPXHP.js");
    case "./translations/sv.json":
      return import("./sv.json-E4XPFTXW.js");
    case "./translations/th.json":
      return import("./th.json-52SS5SVM.js");
    case "./translations/tr.json":
      return import("./tr.json-42Y4XYZS.js");
    case "./translations/uk.json":
      return import("./uk.json-76BICWJE.js");
    case "./translations/vi.json":
      return import("./vi.json-D7RT5ZHT.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-72LLUYVH.js");
    case "./translations/zh.json":
      return import("./zh.json-XGGPYK7J.js");
    default:
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-JVAJ6VY7.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-CFE3CDEF.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-CFE3CDEF.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-CFE3CDEF.js");
...
//# sourceMappingURL=chunk-RP6PYQ64.js.map
