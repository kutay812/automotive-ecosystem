...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.DefaultTo<'Benzin'>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::car.car'> &
      Schema.Attribute.Private;
    luggageCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<2>;
    model: Schema.Attribute.String;
    passengerCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
    pricePerDay: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    transmission: Schema.Attribute.Enumeration<['Otomatik', 'Manuel']> &
      Schema.Attribute.DefaultTo<'Otomatik'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Locations for car pick-up and drop-off';
    displayName: 'Office';
    pluralName: 'offices';
    singularName: 'office';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Media production showcase';
